            ...
            <div className="col mb-5">
                ...
                <div className="card">
                    <div className="card-body">
                        <div className="row">
                            <div className="col">
                                <h5 className="card-title">Různých zvířat mělo report za každý měsíc v roce 2020: </h5>
                                <div className="row">
                                    <div className="col-5">
                ...
                <div className="card">
                    <div className="card-body">
                        <div className="row">
                            <div className="col">
                                <h5 className="card-title">Operací typu Vakcinace na reportech za každý měsíc v roce 2020: </h5>
                                <div className="row">
                                    <div className="col-5">
                                        <ul className="list-group list-group-flush">
                                            <li className="list-group-item d-flex justify-content-between align-items-center">
